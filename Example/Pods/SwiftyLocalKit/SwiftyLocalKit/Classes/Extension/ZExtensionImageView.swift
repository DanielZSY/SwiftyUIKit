...
extension UIImageView {
    ...
    public func setPhotoWitUrl(strUrl: String, placeholder: UIImage?) {
    ...
    public func setImageWitUrl(strUrl: String, placeholder: UIImage?, style: UIActivityIndicatorView.Style = .white) {
        ...
        if self.aiView == nil {
            let aiView = UIActivityIndicatorView.init(style: style)
