...
public class ZModelRoom: ZModelBase {
    ...
    public var room_user_local: ZModelUserLocal?
    public var room_ownerid: String = ""
    public var room_name: String = ""
    public var room_type: ZEnumRoomType = .video
    ...
    public required init<T: ZModelBase>(instance: T) {
        ...
        if let user = model.room_user_local {
            self.room_user_local = ZModelUserLocal.init(instance: user)
        }
    ...
    public required init(row: Row) {
        ...
        self.room_user_local = ZModelUserLocal.init(row: row)
