...
public class ZModelUserLocal: ZModelBase {
    
    public class override var databaseTableName: String { "tb_user" }
    public enum Columns: String, ColumnExpression {
        case token, userid, password, role, nickname, gender, avatar, age, birthday, height, weight, bodytype, belong, country, countrycode, province, city, email, tel, introduction, balance, photos, videos, show_location, incognito_mode, is_follow, is_black
    }
    public var token: String = ""
    public var password: String = ""
    public var userid: String = ""
    public var nickname: String = ""
    public var role: ZEnumUserRole = .user
    public var gender: ZEnumUserGender = .none
    ...
    public required init<T: ZModelBase>(instance: T) {
        ...
        guard let model = (instance as? ZModelUserLocal) else {
            return
        }
    ...
    public required init(row: Row) {
        ...
        self.is_black = row[Columns.is_black] ?? false
        self.is_follow = row[Columns.is_follow] ?? false
    }
    public override func encode(to container: inout PersistenceContainer) {
        ...
        container[Columns.is_black] = self.is_black
        container[Columns.is_follow] = self.is_follow
    }
