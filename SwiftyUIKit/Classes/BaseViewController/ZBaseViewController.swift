...
open class ZBaseViewController: UIViewController {
    ...
    open override func viewDidLoad() {
        ...
        self.view.backgroundColor = ZUIColor.shared.ViewBackgroundColor
        ...
        self.navigationController?.navigationBar.tintColor = ZUIColor.shared.NavBarTitleColor
        self.navigationController?.navigationBar.titleTextAttributes = [.foregroundColor: ZUIColor.shared.NavBarTitleColor]
    }
    open override func viewWillAppear(_ animated: Bool) {
        ...
        (self.navigationController as? ZNavigationController)?.shadowImage = UIImage.init(color:  ZUIColor.shared.NavBarLineColor)?.withAlpha(self.isNavigationAlpha)
        (self.navigationController as? ZNavigationController)?.backgroundImage = UIImage.init(color: ZUIColor.shared.NavBarTintColor)?.withAlpha(self.isNavigationAlpha)
    ...
    public final func setNavBarRightButton(text: String, color: UIColor? = ZUIColor.shared.NavBarButtonColor, highlightedColor: UIColor? = ZUIColor.shared.NavBarButtonColor) {
