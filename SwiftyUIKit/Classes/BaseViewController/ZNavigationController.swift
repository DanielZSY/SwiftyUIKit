...
public class ZNavigationController: UINavigationController {
    ...
    private func innerInitView() {
        ...
        self.navigationBar.tintColor = ZUIColor.shared.NavBarButtonColor
        self.shadowImage = UIImage.init(color: ZUIColor.shared.NavBarLineColor)?.withAlpha(0)
        self.backgroundImage = UIImage.init(color: ZUIColor.shared.NavBarTintColor)?.withAlpha(0)
    }
}
